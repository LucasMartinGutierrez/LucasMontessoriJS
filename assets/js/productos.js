...
/* const productos = [
    productos.push(new producto(A1,"ARCOIRIS WALDORF", 2300)),
    productos.push(new producto(A2,"MINI CUNA", 4200)),
    productos.push(new producto(A3,"HERRAMIENTAS", 2880)),
    productos.push(new producto(A4,"BALANCIN FULL COLOR", 6900)),
    productos.push(new producto(A5,"PATA PATA", 6900)),
    ]; */
